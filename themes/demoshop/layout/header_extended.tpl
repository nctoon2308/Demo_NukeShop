        ...
        <div class="section-header">
            <div class="wraper">
                <div id="header">
					...
					<div class="col-xs-24 col-sm-18 col-md-9">
                        [MENU1]     
                        </div>
                    <div class="headerSearch col-xs-24 col-sm-6 col-md-7">
                    ...
                    <div class="col-xs-24 col-sm-6 col-md-1">
                    </div>
                    <div class="col-md-4">
                        <a class="cart" href=""><img src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSjf7ePpER2KwU9-6jFb33amb2o4fpXQJaqMqu_pXw&usqp=CAU">
                        </a>
                        </div>
                   	<div class="right-ads">
                        [HEAD_RIGHT]
